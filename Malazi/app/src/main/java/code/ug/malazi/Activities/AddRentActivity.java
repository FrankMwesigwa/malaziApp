...
public class AddRentActivity extends AppCompatActivity implements BSImagePicker.OnMultiImageSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category.add("Villa");
        category.add("Bungalow");
        category.add("Suite");
        category.add("Apartments");

        final FormElementPickerSingle elementType = FormElementPickerSingle.createInstance().setTitle("Select Category")
                .setTag(894).setOptions(category).setPickerTitle("Select Category");
        ...
        mSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFormBuilder.getFormElement(894).getValue().equals("Villa")) {
                    subCategory = "55c9017b625d1c6a1b198070";
                } else if (mFormBuilder.getFormElement(894).getValue().equals("Bungalow")) {
                    subCategory = "75973ecd1f053aa52b19fde9";
                } else if (mFormBuilder.getFormElement(894).getValue().equals("Suite")) {
                    subCategory = "ba1d92c5693afd58a6411a06";
                } else if (mFormBuilder.getFormElement(894).getValue().equals("Apartments")) {
                    subCategory = "c2b45a1925482fd73ba4b342";
                }
                ...
                if (elementName.getValue().length() < 3 && elementCity.getValue().length() < 3 && elementLocation.getValue().length() < 3 &&
                    ...
                    Toasty.warning(AddRentActivity.this, "Please Enter All Details", Toast.LENGTH_SHORT, true).show();
                } else if (images.length == 0) {
                    Toasty.warning(AddRentActivity.this, "Please Select Images", Toast.LENGTH_SHORT, true).show();
                } else {
    ...
    public void sendInfo(final String name, final String city, final String location, final String bed, final String bath,
        ...
        client.post("https://api.malazi.net/user/" + userID+ "/upload_property", params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response){
                ...
                new SweetAlertDialog(AddRentActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sDialog) {
                                ...
                                Intent intent = new Intent(AddRentActivity.this, MainActivity.class);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                ...
                hideDialog();
                new SweetAlertDialog(AddRentActivity.this, SweetAlertDialog.ERROR_TYPE)
                        .setTitleText("Failed")
