...
public class ChatListAdapter extends BaseAdapter {
    ...
    public ChatListAdapter(Activity activity, DatabaseReference ref, String name, String msgId){
//        sharedpreferences = getSharedPreferences(mypreference, Context.MODE_PRIVATE);
//        String userID = (sharedpreferences.getString(USERID, ""));

        mActivity = activity;
        mDisplayName = name;
        mDatabaseReference = ref.child(msgId);
    ...
    private void setChatRowAppearance(boolean isItMe, ViewHolder holder){
        if (isItMe) {
            ...
            holder.authorName.setVisibility(View.INVISIBLE);
            holder.body.setBackgroundResource(R.drawable.btn1);
        } else {
            holder.params.gravity = Gravity.START;
            holder.authorName.setTextColor(Color.WHITE);
            holder.body.setBackgroundResource(R.drawable.btn);
